...
import { Input, Accordion, Typography, AccordionSummary, Card, CardContent, makeStyles, Paper } from "@material-ui/core";
        ...
        key={index}>
          <CardContent>
            ...
            <Accordion>
              ...
              <div>
                <Paper elevation={0} variant="outlined" style={{textAlign: "center", backgroundColor:"rgba(250, 128, 114, 0.5)"}}>
