...
export  default async function busca (req:NextApiRequest, res:NextApiResponse) {
  ...
  : (req.query.opcion === 'difusion') ? '1pQe7vhFujf1a0pr3bfmN4tR9kd8-cVcM'
  : (req.query.opcion === 'noticias') ? '1Xd4hBk6oGz8FIC6rBdcM44TdTTuI5xdg'
  : (req.query.opcion === 'documentos') ? '1yWfAEKX-869SGntzl8jrxq66HIlK5Jvb' : false
